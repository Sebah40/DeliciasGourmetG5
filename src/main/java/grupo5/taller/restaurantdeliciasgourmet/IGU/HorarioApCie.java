...
public class HorarioApCie extends javax.swing.JFrame {
...
private JSpinner spinnerHoraApertura;
    ...
    public HorarioApCie() {
        ...
        setTitle("Configuración de Horarios del Restaurante");
        setSize(400, 200);
        ...
        JLabel lblHoraCierre = new JLabel("Hora de Cierre:");
        ...
        btnGuardar = new JButton("Guardar Horarios");
