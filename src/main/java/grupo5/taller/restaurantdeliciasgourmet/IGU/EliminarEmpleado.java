...
public class EliminarEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEliminar.setMaximumSize(new java.awt.Dimension(145, 39));
        btnEliminar.setMinimumSize(new java.awt.Dimension(145, 39));
        btnEliminar.setPreferredSize(new java.awt.Dimension(145, 39));
        ...
        jLabel2.setText("Ingrese el correo del empleado a eliminar");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
      ...
      for(Empleado e:empleados){
          if(e.getCorreoElectronico().equals(jTextCorreo.getText())){
              empleadoService.deleteEmpleado(e);
