...
public class CancelarReserva extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEliminarReserva.setText("Cancelar Reserva");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(btnEliminarReserva, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
    ...
    private void btnVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVolverActionPerformed
       PantallaPrincipal pincWindow = RestaurantDeliciasGourmet.getContext().getBean(PantallaPrincipal.class);
        pincWindow.setVisible(true);
        this.dispose();
    ...
    try{
        int clienteId = SessionManager.getInstance().getCurrentCliente().getClienteId();
        int selectedIndex = tbl_listaReservas.getSelectedIndex();
    if (selectedIndex == -1) {
        JOptionPane.showMessageDialog(this, "Por favor, seleccione una reserva.");
        return;    
    }//GEN-LAST:event_btnEliminarReservaActionPerformed
     List<Reserva> availableReservas = reservaService.getReservasFromCliente(clienteId);
     Reserva selectReserva = availableReservas.get(selectedIndex);
     int idres = selectReserva.getIdReserva();
     reservaService.cancelarReserva(idres);
     javax.swing.JOptionPane.showMessageDialog(this, "Reserva Cancelada.");
    }catch (Exception e){
    
        javax.swing.JOptionPane.showMessageDialog(this, "Error al cancelar reserva: " + e.getMessage(), "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
